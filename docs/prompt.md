tôi đang muốn làm 1 desktop app bằng electron (chủ yếu cho linux, sẽ mở rộng cho windows, macos sau) tên là ScreenAwesome -  một screen recorder + edit studio như là Screen Studio. các tính năng:
